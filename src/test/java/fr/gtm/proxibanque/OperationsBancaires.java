...
public class OperationsBancaires {
	...
	public void retraitCarte(Compte compte, String type) throws CompteException {
		...
		if (compte.getCarteBleue() != null) {					
			if(compte.getCarteBleue().getDateExpiration().isAfter(today)) throw new CompteException("Impossible d’effectuer le retrait, votre ancienne carte est encore valide");
		}		
	}
